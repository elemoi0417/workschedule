...
namespace workschedule.Reports
{
    class Ward3_Youshiki9
    {
        ...
        const int ROW_WARD_COUNT = 6;
        const int ROW_BED_COUNT = 8;
        const int ROW_AVERAGE_DAY = 13;
        const int ROW_AVERAGE_DAY_START_YEAR = 13;
        const int ROW_AVERAGE_DAY_START_MONTH = 13;
        const int ROW_AVERAGE_DAY_END_YEAR = 13;
        const int ROW_AVERAGE_DAY_END_MONTH = 13;
        const int ROW_TARGET_YEAR = 37;
        const int ROW_TARGET_MONTH = 38;
        const int ROW_WORK_DAYS = 37;

        const int COLUMN_NURSE_STAFF_START = 1;
        const int COLUMN_NURSE_DAY_START = 15;
        const int ROW_NURSE_DAY = 42;
        const int ROW_NURSE_DAY_OF_WEEK = 43;
        const int ROW_NURSE_STAFF_START = 44;
        const int ROW_NURSE_STAFF_END = 343;

        const int COLUMN_CARE_STAFF_START = 2;
        const int COLUMN_CARE_DAY_START = 15;
        const int ROW_CARE_DAY = 351;
        const int ROW_CARE_DAY_OF_WEEK = 352;
        const int ROW_CARE_STAFF_START = 353;
        const int ROW_CARE_STAFF_END = 652;

        // 変数
        string strFilePath = Environment.CurrentDirectory + @"\Report\ward3_youshiki9.xlsx";
        ...
        /// クラス初期化
        /// </summary>
        public Ward3_Youshiki9(string strTargetMonth, string strWard, string strWardName)
        {
            // 共通変数をセット
