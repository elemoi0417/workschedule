...
namespace workschedule.Reports
{
    class Ward2_Youshiki9
    {
        ...
        // 変数
        string strFilePath = Environment.CurrentDirectory + @"\Report\ward2_youshiki9.xlsx";
        ...
        /// クラス初期化
        /// </summary>
        public Ward2_Youshiki9(string strTargetMonth, string strWard, string strWardName)
        {
            // 共通変数をセット
