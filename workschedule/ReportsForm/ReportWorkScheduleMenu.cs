...
{
    public partial class ReportWorkScheduleMenu : Form
    {
        // 使用クラス宣言
        DatabaseControl clsDatabaseControl = new DatabaseControl();

        public ReportWorkScheduleMenu()
        {
            InitializeComponent();
        ...
        {
            PrintWorkSchedule clsPrintWorkSchedule = new PrintWorkSchedule(cmbWard.SelectedValue.ToString(), cmbWard.Text, cmbTargetYear.Text, cmbTargetMonth.Text);
