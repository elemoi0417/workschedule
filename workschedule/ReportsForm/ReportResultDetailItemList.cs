...
{
    public partial class ReportResultDetailItemList : Form
    {
        // 使用クラス宣言
        DatabaseControl clsDatabaseControl = new DatabaseControl();

        public ReportResultDetailItemList()
        {
            InitializeComponent();
            ...
            cmbResultDetailWorkKind.SelectedIndex = 0;
        ...
        {
            PrintResultDetailWorkKind clsPrintResultDetailWorkKind = new PrintResultDetailWorkKind(
                cmbTargetYear.Text + cmbTargetMonth.Text, cmbWard.SelectedValue.ToString(), cmbWard.Text, cmbResultDetailWorkKind.Text);
            clsPrintResultDetailWorkKind.SaveFile();
        }
